...
export class MembersComponent implements OnInit, AfterViewInit {
  ...
  public addMember() {
    var member: Member = {
      dbKey: "", id: '', membershipNumber: 0, admin: false, treasurer: false, committeeMember: false, secretary: false, membershipSecretary: false, matchSecretary: false, previewer: false, allowNameToBeUsed: false, name: '', email: '', seasonsActive: [], pinResetRequired: true, preferencesLastUpdated: new Date(), reLoginRequired: false, initialPin: 0,
      surname: ''
    };
